...
@section('title', "Monthly Transaction")
            ...
            <div style="min-height: 440px" class="a bg-purple round-this border-black">
                <div class="bg-purple px-5 pt-3 pb-4" style="border-radius: 20px">
                    ...
                    <div class="row mx-0 d-flex gx-5  align-items-center">
                        @php($currentYear = Carbon::now()->format('Y'))
                        <div class="col-xl-4 col-lg-4">
                           <span class="d-inline-flex pb-1
                                ...
                                <a href="{{route('monthly-transactions', ['month'=>$activeMonth])}}"
                                   class="text-decoration-none nice-white-shadow">
                                    <u class="fs-4 text-white">Month : {{$activeMonthText}}</u>
                                </a>
                            </span>
                        </div>
                    ...
                    <div style="width: 80%; margin: 0 auto;">
                        <div class="p-5 bg-white round-this shadow-this-down">
                            ...
                            <div class="row px-0 mt-1 mb-2">
                                {{--DROPDOWN--}}
                                <div class="row mx-0 px-0 d-flex col-lg-4 col-12">
                                    ...
                                    <select name="" id="monthSelect" class="form-select col height-40">
                                        <option value="" class="disable" disabled>Select month</option>
                                        @for($i=1; $i<=12; $i++)
                                            <option value="{{$i}}" @selected($activeMonth == $i)>
                                                {{Carbon::create($year, $i)->format('M')}}
                                            </option>
                                        @endfor
                                    </select>
                                </div>
