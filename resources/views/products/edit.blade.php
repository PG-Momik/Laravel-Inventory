                                ...
                                <div class="form-row row m-0">
                                    <div class="col-lg-3 col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-append">
                                                    <span class="input-group-text btn-danger text-white calcMinusBtn"
                                                          id="" onclick="subtract(1)">
                                                        <i class="fa-solid fa-minus py-1"></i>
                                                    </span>
                                                </div>
                                                <input type="text"
                                                       class="form-control calcField"
                                                       id="productPrice"
                                                       name="price"
                                                       placeholder="Product Quantity"
                                        ...
                                        {{--                                        Discount--}}
                                        <div class="col-12">
                                            <label for="productQuantity">Discount</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text btn-danger text-white calcMinusBtn"
                                                          id="" onclick="subtract(2)">
                                                        <i class="fa-solid fa-minus py-1"></i>
                                                    </span>
                                                </div>
                                                <input type="text"
                                    ...
                                    <div class="col-lg-3">
                                        <p for="" class="text-center">Click to change</p>
                                            ...
                                            <div class="text-center" id="imageWrapper">
                                                ...
                                                @else
                                                    <div>
                                                        ...
                                                        <div class="text-pm-grey" id="noImageText">No Image Available</div>
